...
@Component({
  selector: 'app-dalle-create',
  templateUrl: './dalle-create.component.html',
  styleUrls: ['./dalle-create.component.scss'],
})
export class DalleCreateComponent implements OnInit {
  prompt: string = '';
